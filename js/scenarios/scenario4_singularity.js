...
// 各ルートはそれぞれ人間用/AI用/ASIデモプレイの3択を持つ独立した単発ボス戦。
//   「死ぬがよい」ルート = 二層式洗濯機(二層逆回転型の回転撃ち弾幕。スペカ名なし)
//   「君ならできるよ（笑）」ルート = 葡萄(大玉高密度ランダム散布型弾幕。全画面に降り注ぐ)
//======================================================================
(function(){
...
const washingMachineRoute = {
  name:"死ぬがよい", sub:"二層式洗濯機",
  // subを省略するとエンジン側のEASY〜LUNATIC用フレーバーテキストにフォールバックしてしまうため、
  // 人間用/AI用それぞれに専用のsubを明示する
  diffOptions: [
    {name:"人間用", sub:"弾速・密度ひかえめ"},
    {name:"AI用",   sub:"弾速・密度フルスロットル"},
  ],
